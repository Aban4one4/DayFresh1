...
public class SendMailUtil{
	...
	public SendMailUtil(String userName, String pwd) {
		super();
		this.userName = userName;
		this.pwd = pwd;
	}
	...
	public boolean sendHtmlMail(String receiveAccount, String name, String code) throws MessagingException{
		...
		String content = "<span style=\"font-size:16px;font-weight:blod;font-family:'微软雅黑'\">尊敬的 "+name+" ，您好：</span><br /><br />" +
				...
				"欢迎，您本次的注册码为 <span style='font-size:25px;font-weight:bold'>"+code+"</span>，3分钟之内有效，请尽快使用！</span><br/><br /><span style=\"font-size:14px;font-family:'微软雅黑';float:right;\">"
